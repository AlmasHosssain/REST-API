...
const contantDetails = new Schema({
    name:{
        type:String,
        required : true,
        trim : true,
...
const Contact = mongoose.model('Contact',contantDetails);
...
app.put('/:id',(req,res,next)=>{
    ...
    Contact.findByIdAndUpdate(id,{$set : updateContent})
        .then((contact)=>{
